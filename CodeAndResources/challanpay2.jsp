...
String no=(String)session.getAttribute("cno");

session.setAttribute("ch",no);
session.setAttribute("am",amount);
...
<div align="left">
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="1071" height="322">
    <tr>
      ...
      <p align="center"><font size="7" color="#111111">Payment Gateway</font></td>
    </tr>
    <tr>
      <td width="525" height="52">Bank</td>
      <td width="540" height="52">
      <form method="POST" name="f1" action="http://localhost:8081/ser/challanpaydb.jsp" onSubmit="return valid()">
    ...
    <tr>
      ...
      <td width="540" height="59"><input type="password" name="T2" size="20"></td>
    </tr>
    <tr>
      <td width="525" height="58">Amount</td>
      <td width="540" height="58">&nbsp;<%=chamt%>Rs.</td>
    </tr>
    <tr>
