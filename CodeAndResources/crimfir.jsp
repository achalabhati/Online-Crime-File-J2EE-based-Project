...
ResultSet rs=s.executeQuery("select * from cfir2");
while(rs.next())
{
 x=rs.getInt(15);
...
s.close();
			...
			PreparedStatement pst = c.prepareStatement("insert into cfir2 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			pst.setString(1, s1);
                         pst.setString(2, s2);
			pst.setInt(3, i3);
			pst.setDouble(4,i4);
...
PreparedStatement ps8=c.prepareStatement("update cfir2 set OFFICER_ID=? where caseid=?");
ps8.setInt(1,p_id);
ps8.setInt(2,y);
ps8.executeUpdate();	
ps8.close();
...
PreparedStatement ps6=c.prepareStatement("update cfir2 set officer_name=? where caseid=?");
...
<div align="center">
  <center>
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="822" height="170" id="AutoNumber1">
    <tr>
      <td width="379" height="170">Case ID</td>
      <td width="437" height="170">&nbsp;<%=y%></td>
    </tr>
<tr>
      <td width="379" height="170">Officer Assigned ID</td>
      <td width="437" height="170">&nbsp;<%=p_id%></td>
    </tr>
<tr>
      <td width="379" height="170">Officer Assigned Name</td>
      <td width="437" height="170">&nbsp;<%=name%></td>
    </tr>
  </table>
  </center>
</div>
