...
if(s2.equals("Civil"))
	{			
 ps2=c.prepareStatement("select vname,vaddress,vage,vphoneno,cname,caddress,cage,casetype,cdate,ctime,venue,aboutcase,status from cfir where caseid=?");
ps2.setInt(1,i2);
...
<div align="center" style="width: 1241; height: 225">
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="1237" height="914" id="AutoNumber1">
    <tr>
      ...
      <p align="center"><u><b>
      <font size="7" face="Comic Sans MS" color="#FFFFFF">MEMBER MODULE</font></b></u></td>
    </tr>
    <tr>
