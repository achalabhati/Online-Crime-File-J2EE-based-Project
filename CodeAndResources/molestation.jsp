...
<%session.setAttribute("p","molestation");
 %>
...
<div align="center" style="width: 1158; height: 317">
  ...
  <tr>
      <td width="1158" height="45">
        ...
        <p align="left">
        <input type="radio" value="V1" checked name="R1">Section 372-Selling a 
        minor for the purpose of prostitution</p>
      
      <p>&nbsp;</td>
    </tr>
    <tr>
      <td width="1158" height="68">
        <input type="radio" value="V2"  name="R1">Section 375-Rape</td>
    </tr>
    <tr>
      <td width="1158" height="68">
        <input type="radio" value="V3"  name="R1">Section 376-A&nbsp; Rape by a 
        husband with wife during separation</td>
    </tr>
    <tr>
      <td width="1158" height="62">
        <input type="radio" value="V4"  name="R1">Section 367-B-Rape by 
        government official during duty hours</td>
    </tr>
    <tr>
