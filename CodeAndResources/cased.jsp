...
if(s1==null||s1=="")
{
alert("Please enter the CaseID ID");
return false;
}
...
<div align="center" style="width: 1237; height: 379">
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="1237" height="349" id="AutoNumber1">
    ...
    <tr>
      ...
      <p align="center"><font size="5"><a href="">View Case Details</a></font></td>
    </tr>
    <form  name="f1" method="POST" action="http://localhost:8081/ser/cas.jsp" onSubmit="return valid()">
    <tr>
